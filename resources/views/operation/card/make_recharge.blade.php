...
@section('title')
    {{ __('app.card.make_recharge_title') }}
@endsection
    ...
    <div class="container-fluid px-md-5">
        <div class="row px-md-5 mx-md-5">
            <div class="col px-md-5">
                <h1 class="h5 text-main pt-4">{{ strtoupper(__('app.card.make_recharge_title')) }}</h1>
                <p class="text-muted small">{{ __('app.card.make_recharge_subtitle') }}</p>

                <div class="card bg-light mt-5 mb-3">
                    <div class="card-header text-muted small py-1">{{ strtoupper(__('app.card.recharge_title')) }}</div>
                    <div class="card-body">
                        <form class="form-horizontal" action="" autocomplete="on">
                            ...
                            <div class="form-group form-row">
                                <label class="control-label col-md-3 text-right" for="type">{{__('app.card.to_card')}}:</label>
                                <div class="col">
                                    <select id="inputState" class="form-control form-control-sm">
                                        <option selected>{{ strtoupper(__('app.card.select_card')) }}</option>
                                    </select>
                                    <a href="#"><span class="float-right"><i class="fas fa-plus text-main"></i> {{ __('app.card.add_card') }}</span></a>
                                </div>
                            </div>
                            <div class="form-group form-row">
