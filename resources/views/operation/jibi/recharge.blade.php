        ...
        <div class="row px-5 mx-5">
            <div class="col px-5">
                ...
                <div class="card bg-light mt-5 mb-3">
                    <div class="card-header text-muted py-1">{{ strtoupper(__('app.jibi.recharge_title')) }}</div>
                    <div class="card-body">
                    ...
                    <div class="card-footer bg-light">
                        <button type="submit" class="btn bg-light float-left">{{__('app.cancel')}}</button>
                        <button type="submit" class="btn bg-main float-right">{{__('app.valid')}}</button>
                    </div>
                </div>
            </div>
        </div>
